...
export default function App() {
  ...
  async function runScan(event) {
    ...
    try {
      const response = await fetch("/scans", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ target, scanners: ["source", "binary", "container", "dependency"] }) });
      if (!response.ok) {
